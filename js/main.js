    ...
    Swal.fire({
        ...
        Swal.fire({
            ...
            backdrop: `
              ...
              no-repeat
            `,
            html: "<video width='300px' poster="images.wondershare.com/recoverit/article/2019/11/common-video-errors-01.jpg" controls autoplay> <source src = 'video/IMG_E3362.mp4 ' /> > Your browser does not support the video tag </video> ",
            background: '#fff url("img/birthday.jpg")',
            imageAlt: 'Custom image',
            confirmButtonText: CONFIG.btnIntro
        }).then(function() {
